...
export const changelogs: ChangelogEntry[] = [
    {
        ...
        changes: [
            { type: "fix", description: "changelog.v151.regression" },
            { type: "fix", description: "changelog.v151.health" }
        ]
    },
    {
        version: "1.5.0",
        date: "2026-04-19",
        title: "changelog.v150.title",
        changes: [
            { type: "new", description: "changelog.v150.caching" },
            { type: "improvement", description: "changelog.v150.algorithm" },
            { type: "new", description: "changelog.v150.pagination" },
            { type: "improvement", description: "changelog.v150.indexing" },
            { type: "new", description: "changelog.v150.monitoring" }
        ]
    },
    {
        version: "1.4.0",
        date: "2026-01-23",
        title: "changelog.v140.title",
        changes: [
            { type: "new", description: "changelog.v140.focus" },
            { type: "improvement", description: "changelog.v140.mobile" },
            { type: "improvement", description: "changelog.v140.perf" },
            { type: "new", description: "changelog.v140.aria" }
        ]
    },
    {
        version: "1.3.1",
    ...
    },
    {
        ...
        changes: [
            { type: "new", description: "changelog.v059.analytics" },
            { type: "new", description: "changelog.v059.themes" },
            { type: "improvement", description: "changelog.v059.dashboard" },
            { type: "improvement", description: "changelog.v059.notes" }
        ]
    },
    {
        version: "0.5.8",
        date: "2026-01-11",
        title: "changelog.v058.title",
        changes: [
            { type: "new", description: "changelog.v058.tts" },
            { type: "new", description: "changelog.v058.stt" },
            { type: "new", description: "changelog.v058.library" },
            { type: "improvement", description: "changelog.v058.dashboard" }
        ]
    },
    {
        version: "0.5.7",
        date: "2026-01-10",
        title: "changelog.v057.title",
        changes: [
            { type: "improvement", description: "changelog.v057.cork" },
            { type: "new", description: "changelog.v057.pins" },
            { type: "fix", description: "changelog.v057.documents_fix" },
            { type: "fix", description: "changelog.v057.reset_view" }
        ]
    },
    {
        version: "0.5.6",
        date: "2026-01-10",
        title: "changelog.v056.title",
        changes: [
            { type: "new", description: "changelog.v056.documents" },
            { type: "improvement", description: "changelog.v056.filters" }
        ]
    },
    {
        version: "0.5.5",
        date: "2026-01-10",
        title: "changelog.v055.title",
        changes: [
            { type: "new", description: "changelog.v055.board_complete" },
            { type: "new", description: "changelog.v055.drag_drop" },
            { type: "new", description: "changelog.v055.filters" },
            { type: "improvement", description: "changelog.v055.layout" },
        ]
    },
    {
        version: "0.5.4",
