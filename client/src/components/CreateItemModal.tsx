...
const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (type === 'resource' && file) {
        ...
        formData.append('fileName', fileToUpload.name); // Compression might change name or extension? usually keeps it or adds something. 
        // browser-image-compression result is a Blob/File. 
        // If it converts to blob, we might need to cast to File or ensure name property.
        // library returns File.
