...
const translations: Translations = {
    ...
    fr: {
        ...
        "changelog.v051.mobile": "Optimisation Mobile : Refonte de la vue cours pour smartphone avec des cartes plus compactes et un en-tête intelligent.",
        "changelog.v051.folders": "Navigation Fluide : Les dossiers sont désormais ouverts par défaut pour un accès direct à vos cours.",
        "changelog.v051.office": "Lecteur Office Hybride : Passage au lecteur Google Docs pour une ouverture fiable des PPT et Excel.",
        "changelog.v051.api": "Intercepteur API : Détection automatique des sessions expirées et reconnexion intelligente.",
        "changelog.v051.deps": "Dépendances : Réparation des erreurs de compilation liées aux modules Word et HEIC.",
        "changelog.v051.prisma": "Synchro Prisma : Mise à jour du moteur de base de données pour une cohérence parfaite des types serveur.",
