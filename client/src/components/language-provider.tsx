...
const translations: Translations = {
    en: {
        ...
        "view.thumbnails_off": "Show Thumbnails",
        ...
        "item.form.hasDueDate": "Set a deadline (add to calendar)",
        "item.form.dueDate": "Deadline",
        "item.form.dueDate.hint": "This exercise will automatically be added to your calendar for this date.",
        ...
        "action.import": "Import File",
        "import.error.format": "Unsupported file format.",
        ...
        "folder.edit": "Rename Folder",
        "folder.edit.title": "Rename Folder",
        "folder.rename.prompt": "Enter new folder name:",
        "folder.update.success": "Folder renamed successfully",
        "folder.update.error": "Failed to rename folder",
        ...
        "tts.empty": "No text to read",
        "tts.unsupported": "Text-to-speech not supported by your browser",
        ...
        "bulk.delete_confirm": "Are you sure you want to delete the selected items?",
        "bulk.delete_success": "Items deleted successfully",
        "bulk.delete_error": "Error deleting items",
        "bulk.delete_partial_error": "Some items could not be deleted",
        "common.back": "Back",
        // Settings Page
        ...
        "settings.interface.explorer": "Show Explorer Section (Mind Maps, Board)",
        ...
        "settings.api.gemini.vincent": "Google Gemini",
        ...
        "settings.api.integrations": "External Integrations (Google Drive, Calendar)",
        "settings.api.finance.title": "Finance Audit AI",
        "settings.api.finance.provider": "AI Provider",
        "settings.api.finance.model": "AI Model",
        // Generation Menu
        ...
        "changelog.v200.title": "Real-time Notes, PDF & Next-Gen AI 🚀",
        "changelog.v200.notes_autosave": "Live Auto-Save: Automatic Google Docs-style real-time saving with status badge.",
        "changelog.v200.notes_wysiwyg": "WYSIWYG Notes: Faithful layout and line-break preservation in view mode.",
        "changelog.v200.pdf_viewer": "Hybrid PDF Reader: Fast native inline reader with smooth interactive Canvas mode.",
        "changelog.v200.focus_mode": "Mobile Focus Mode: Immersive in-page fullscreen adapted to smartphone screens.",
        "changelog.v200.grid_uniformity": "Uniform Cards: Locked 16:9 thumbnails and evenly aligned grid heights.",
        "changelog.v200.flashcards": "Localized Flashcards: Full French UI and rich Markdown text formatting.",
        "changelog.v200.google_drive": "Google Drive Sync: Direct file picker with 1-click re-sync for files.",
        "changelog.v200.ai_models": "Gemini 3.8 & Isolated Keys: Latest AI models with secure per-user keys.",
        "changelog.v200.pwa": "PWA & Themes: Installable app and authentic parchment Minecraft theme.",
        "changelog.v200.sidebar": "Clean Navigation: Streamlined sidebar focused on courses and folders.",
        ...
        "finance.title": "FinanceTrack",
        "finance.subtitle": "Manage your finances like a pro.",
        "finance.dashboard.title": "Portfolio",
        "finance.dashboard.newOp": "New Transaction",
        "finance.dashboard.internal": "Internal Transfers",
        "finance.dashboard.internal.show": "Show internal transfers",
        "finance.dashboard.internal.hide": "Hide internal transfers",
        "finance.dashboard.deleteAccount": "Delete this account",
        "finance.dashboard.deleteAccount.confirm": "Delete this account and all its transactions?",
        "finance.dashboard.deleteAccount.success": "Account deleted successfully.",
        "finance.dashboard.audit.title": "Financial Audit",
        "finance.dashboard.audit.generating": "Generating audit...",
        "finance.dashboard.audit.error": "Error generating audit.",
        "finance.stats.balance": "Total Balance",
        "finance.stats.balance.all": "All accounts",
        "finance.stats.income.month": "Income (Month)",
        "finance.stats.expenses.month": "Expenses (Month)",
        "finance.stats.currentMonth": "This month",
        "finance.chart.title": "Balance History",
        "finance.chart.activity": "Activity",
        "finance.chart.scale": "Scale",
        "finance.chart.noData": "No data for this period",
        ...
        "finance.categorize.tooltip": "Auto-categorize transactions using AI",
        "finance.categorize.success": "{{count}} transactions categorized",
        "finance.categorize.error": "AI categorization error",
        "finance.banks.title": "My Banks",
        "finance.banks.popular": "Popular Banks",
        "finance.banks.search": "Search for a bank...",
        "finance.banks.swift": "SWIFT/BIC Code",
        "finance.banks.swift.error": "Invalid SWIFT format (8 or 11 chars)",
        "finance.banks.swift.valid": "Valid format",
        "finance.banks.none": "No bank found",
        "finance.banks.hint": "Click a bank to pre-fill the form",
        "finance.banks.add": "Add Bank",
        "finance.banks.connected.none": "No banks connected",
        "finance.banks.welcome": "Welcome to FinanceTrack! 👋",
        "finance.banks.welcome.desc": "Start by adding your first bank to centralize all your accounts and track your finances in real time.",
        "finance.banks.step1.title": "Add a bank",
        "finance.banks.step1.desc": "Create your first bank entry",
        "finance.banks.step2.title": "Import your statements",
        "finance.banks.step2.desc": "Supports OFX, CSV, and Excel",
        "finance.banks.step3.title": "Manage your budget",
        "finance.banks.step3.desc": "Auto categorization and statistics",
        "finance.banks.count": "{{count}} accounts",
        "finance.banks.edit": "Edit",
        "finance.banks.archive": "Archive",
        "finance.banks.archive.confirm": "Do you want to archive this bank? You can restore it later.",
        "finance.banks.delete": "Permanently delete",
        "finance.banks.delete.confirm": "⚠️ DANGER: Permanently delete this bank and all its data? This action is irreversible. Prefer 'Archive' to keep your data.",
        "finance.banks.noAccounts": "No accounts",
        "finance.banks.addAccount": "Add an account",
        "finance.accounts.edit": "Modify account",
        "finance.accounts.add": "Add an account",
        "finance.accounts.name": "Account Name",
        "finance.accounts.name.placeholder": "e.g. Checking Account",
        "finance.accounts.type": "Type",
        "finance.accounts.type.checking": "Checking",
        "finance.accounts.type.savings": "Savings",
        "finance.accounts.type.credit": "Credit",
        "finance.accounts.type.investment": "Investment",
        "finance.accounts.balance.initial": "Initial Balance",
        "finance.accounts.currency": "Currency",
        "finance.accounts.number": "Account Number (Optional)",
        "finance.accounts.number.placeholder": "e.g. ****1234",
        "finance.accounts.delete.confirm": "Delete this account and all its transactions?",
        "finance.budgets.title": "Monthly Budgets",
        "finance.budgets.new": "New Budget",
        "finance.budgets.none": "No budget defined. Start tracking your spending!",
        "finance.budgets.overview": "Monthly Overview",
        "finance.budgets.pacing": "You are at {{pmonth}}% of the month and have consumed {{pbudget}}% of your global budget.",
        "finance.budgets.total": "Total Budgeted",
        "finance.budgets.edit": "Modify budget",
        "finance.budgets.create": "Create a budget",
        "finance.budgets.category": "Category",
        "finance.budgets.category.placeholder": "Choose a category...",
        "finance.budgets.limit": "Limit Amount (€)",
        "finance.budget.monthly": "Monthly",
        "finance.budget.yearly": "Yearly",
        "finance.budget.edit": "Edit",
        "finance.budget.none": "No budget defined",
        "finance.budget.add": "Add Budget",
        "finance.budget.title": "My Budgets",
        "common.backToDashboard": "Back to Dashboard",
        "finance.bank.balance.total": "Total balance",
        "finance.tx.empty": "No transaction",
        "finance.banks.add.first": "Add my first bank",
        "finance.hero.import.btn": "Import file",
        "common.actions.cancel": "Cancel",
        "finance.account.balance": "Balance",
        "finance.account.noIban": "No IBAN",
        "finance.account.balance.current": "Current balance",
        "finance.budget.limit.exceeded": "Limit exceeded by",
        "finance.budget.remaining": "Remaining:",
        "finance.budget.pacing.high": "High pacing",
        "finance.budget.pacing.low": "Low pacing",
        "finance.budget.pacing.onTrack": "On track",
        "finance.import.title": "Import Transactions",
        "finance.import.upload": "Upload",
        "finance.import.description": "Import your OFX, CSV or Excel statements.",
        "finance.import.step.upload": "Upload",
        "finance.import.step.preview": "Preview",
        "finance.import.step.result": "Result",
        "finance.import.bank.target": "Target Bank",
        "finance.import.bank.select": "Select a bank...",
        "finance.import.bank.none": "No banks configured.",
        "finance.import.bank.createFirst": "Create one first.",
        "finance.import.account.target": "Target Account (Optional)",
        "finance.import.account.help": "Select an account to force import into it, otherwise FinanceTrack will try to detect it.",
        "finance.import.account.auto": "Auto-detection",
        "finance.import.accounts.detected": "Detected accounts",
        "finance.import.dropzone.change": "Change file",
        "finance.import.dropzone.placeholder": "Drop your file here",
        "finance.import.dropzone.accepted": "OFX, CSV or Excel accepted",
        "finance.import.action.analyzing": "Analyzing...",
        "finance.import.action.continue": "Continue to Preview",
        "finance.import.action.confirming": "Importing...",
        "finance.import.action.confirmCount": "Confirm Import ({{count}})",
        "finance.import.summary.total": "Total Transactions",
        "finance.import.summary.new": "New Adds",
        "finance.import.summary.duplicates": "Duplicates Ignored",
        "finance.import.toast.detectingBank": "Bank detected: {{name}}",
        "finance.import.toast.success": "Import successful!",
        "finance.import.toast.error.noFile": "Please select a bank and a file.",
        "finance.import.loading": "Loading banks...",
        "finance.import.error.noIban": "No IBAN",
        "finance.import.success.title": "Import Successful!",
        "finance.import.success.description": "Your transactions have been correctly imported and categorized.",
        "finance.import.success.action.dashboard": "Back to Dashboard",
        "finance.import.success.action.another": "Import another file",
        "finance.import.history": "Import History",
        "finance.tx.new": "Add a transaction",
        "finance.tx.manual": "Manual entry",
        "finance.tx.description": "Description",
        "finance.tx.description.placeholder": "e.g. Rent, Groceries...",
        "finance.tx.amount": "Amount",
        "finance.tx.date": "Date",
        "finance.tx.category": "Category",
        "finance.tx.category.none": "Not classified",
        "finance.tx.noneMonth": "No transactions this month",
        "finance.tx.recent": "Recent Transactions",
        "finance.tx.viewAll": "View all",
        "finance.settings.title": "Finance Settings",
        "finance.settings.description": "Manage your banks, accounts and preferences.",
        "finance.tx.edit.currentClassification": "Current classification",
        "finance.tx.edit.suggested": "Suggested",
        "finance.tx.edit.manual": "Manual",
        "finance.tx.edit.reclassify": "Auto-reclassify",
        "finance.tx.edit.reclassifying": "Reclassifying...",
        "finance.tx.edit.title": "Edit transaction",
        "finance.tx.classification.new": "New classification",
        "finance.tx.classification.external": "External Payment",
        "finance.tx.classification.external.desc": "Transaction to a third party (payments, debits, external transfers)",
        "finance.tx.classification.internal_intra": "Internal Transfer (Same Bank)",
        "finance.tx.classification.internal_intra.desc": "Transfer between accounts of the same bank",
        "finance.tx.classification.internal_inter": "Internal Transfer (Different Banks)",
        "finance.tx.classification.internal_inter.desc": "Transfer between your accounts in different banks",
        "finance.tx.classification.unknown": "Unknown",
        "finance.tx.classification.unknown.desc": "Uncertain or ambiguous classification",
        "finance.tx.linkedAccount": "Beneficiary account",
        "finance.tx.autoReclassify": "Auto-reclassify",
        "finance.tx.type": "Type",
        "finance.tx.type.expense": "Expense",
        "finance.tx.type.income": "Income",
        "finance.tx.success": "Transaction added",
        "finance.tx.edit.success": "Transaction updated",
        "finance.filter.advanced": "Advanced Filters",
        "finance.filter.active": "Active",
        "finance.filter.show": "Show",
        "finance.filter.hide": "Hide",
        "finance.filter.amount": "Amount (€)",
        "finance.filter.min": "Min",
        "finance.filter.max": "Max",
        "finance.filter.account": "Account",
        "finance.filter.account.all": "All accounts",
        "finance.filter.internal.hide": "Hide internal transfers",
        "finance.import.history.title": "Import History",
        "finance.import.history.none": "No import history available.",
        "finance.import.history.date": "Date",
        "finance.import.history.file": "File",
        "finance.import.history.status": "Status",
        "finance.import.history.imported": "Imported",
        "finance.import.history.duplicates": "Duplicates",
        "finance.import.history.errors": "Errors",
        "finance.badge.suggested": "Suggested",
        "finance.badge.manual": "Manual",
        "finance.badge.confidence.high": "High confidence",
        "finance.badge.confidence.medium": "Calculated",
        "finance.badge.confidence.low": "Uncertain",
        "finance.budget.pacing.ahead": "You are at {{pmonth}}% of the month and have consumed {{pbudget}}% of your global budget.",
        "finance.filter.reset": "Reset",
        "finance.filter.apply": "Apply",
        "finance.status.unknown": "Unknown",
        "finance.status.payment": "Payment",
        "finance.status.transfer": "Internal Transfer",
        ...
        "action.createFirstCourse": "Create a course now",
        "sort.label": "Sort by",
        "sort.dateAdded": "Date",
        ...
        "library.desc": "Manage all your courses and learning resources",
        "empty.noCourses": "No courses found",
        "course.edit": "Edit Course",
        "course.title": "Course Title",
        "course.placeholder": "e.g. Mathematics, History...",
        "course.desc": "Description",
        "course.descPlaceholder": "Course description (optional)",
        "course.icon": "Icon",
        "folder.create.success": "Folder created successfully",
        "folder.create.error": "Failed to create folder",
        "folder.delete.success": "Folder deleted successfully",
        "folder.delete.error": "Failed to delete folder",
        "item.form.desc": "Description",
        "item.form.file": "File",
        "item.form.file.placeholder": "Click or drag a file here",
        "item.form.submit.note": "Create Note",
        "item.form.submit.exercise": "Create Exercise",
        "item.form.submit.resource": "Add Resource",
        "item.form.submit.quiz": "Create Quiz",
        "item.form.submit.flashcards": "Create Flashcards",
        "item.form.submit.summary": "Create Summary",
        "export.title": "Export PDF",
        "summary.viewOriginal": "View original",
        "exercise.error.noContent": "No content available to generate exercises. Please make sure the document contains text.",
        "exercise.error.noFocus": "Please select at least one focus area.",
        "settings.api.missing": "API key not configured in settings",
        "error.generic": "An error occurred",
        "error.ai_missing": "AI service is not configured",
        "finance.tx.category.select": "Select a category...",
        "finance.budget.limit": "Limit Amount (€)",
        "finance.categories.title": "Categories",
        "finance.categories.placeholder": "Category name",
        "finance.categories.keywords.placeholder": "Keywords (separated by commas)",
        "finance.categories.edit.name": "Category Name",
        "finance.categories.edit.keywords": "Keywords",
        "finance.categories.edit.keywords.help": "Used for automatic transaction classification",
        "finance.categories.keywords.count": "keywords",
        "finance.dashboard.noData": "No financial data yet",
        "finance.netWorth": "Net Worth",
        "finance.chart.cashflow": "Cash Flow",
        "finance.chart.netWorth": "Net Worth Growth",
        "finance.account.notFound": "Account not found",
        "finance.account.delete.confirm": "Are you sure you want to delete this account?",
        "finance.account.income.total": "Total Income",
        "finance.account.expense.total": "Total Expenses",
        "finance.account.transactions.history": "Transaction History",
        "finance.account.add": "New Account",
        "finance.bank.notFound": "Bank not found",
        "finance.bank.delete.confirm": "Are you sure you want to delete this bank and its accounts?",
        "finance.bank.account.delete.confirm": "Are you sure you want to delete this account?",
        "finance.bank.accounts.associated": "Associated Accounts",
        "finance.bank.accounts.none": "No accounts associated with this bank",
        "finance.bank.accounts.none.help": "Add an account to track your balance and transactions",
        "finance.bank.accounts.addFirst": "Add first account",
        "finance.bank.backToBank": "Back to bank",
        "finance.banks.swift.placeholder": "e.g. SOGEFRPP",
        "import.error.generic": "Error during import",
        "finance.import.account.select": "Select an account...",
        "finance.tx.history.title": "Transactions",
        "finance.tx.update.success": "Transaction updated successfully",
        "finance.tx.update.error": "Error updating transaction",
        "finance.identify.pending": "Categorizing...",
        "finance.identify.tooltip": "Automatically categorize transactions with AI",
        "finance.identify": "Categorize",
        "finance.tx.desc": "Description",
        "finance.optimize": "Optimize",
        "finance.suggestion": "Suggestion",
        "finance.betterOffer": "Better offer available",
        "finance.savings": "Potential savings",
        "finance.tx.autoReclassify.desc": "Rerun classification for all transactions in this category.",
        "finance.tx.autoReclassify.success": "{{count}} transactions reclassified",
        "finance.filter.all": "All types",
        "finance.filter.category": "Category",
        "finance.filter.category.all": "All categories",
        "finance.filter.internal.desc": "Show only external flows",
        "common.confirmDelete": "Are you sure you want to delete this item?",
        "board.note": "NOTE",
        "board.evidence": "EVIDENCE",
        "board.exercise": "EXERCISE",
        "changelog.v151.title": "Data Restoration 🛠️",
        "changelog.v151.regression": "Missing data fix: Resolved a critical issue where courses and items disappeared after the API pagination update.",
        "changelog.v151.health": "System health: Improved dashboard resilience and data integrity checks.",
        "changelog.v055.title": "Investigation Board - Complete",
        "changelog.v055.board_complete": "Phase 3: Search, filters and mini-map to navigate effectively.",
        "changelog.v055.drag_drop": "Drag and drop: Assign orphan courses to topics via drag & drop.",
        "changelog.v055.filters": "Advanced filters (Topics, Courses) for better organization.",
        "changelog.v055.layout": "Improved radial layout algorithm and node positioning.",
        "changelog.v056.title": "Document Integration",
        "changelog.v056.documents": "Documents (PDF, Images, Office files) now appear on the board.",
        "changelog.v056.filters": "Added Documents filter to show/hide items.",
        "changelog.v057.title": "Visual Improvements",
        "changelog.v057.cork": "Enhanced corkboard texture with CSS pattern.",
    ...
    fr: {
        ...
        "filter.exercises": "Exercices",
        "filter.notes": "Notes",
        "filter.flashcards": "Flashcards",
        "filter.quiz": "Quiz",
        "filter.mindmaps": "Cartes Mentales",
        "filter.summaries": "Résumés",
        "view.thumbnails_on": "Masquer Miniatures",
        "view.thumbnails_off": "Afficher Miniatures",
        ...
        "item.form.hasDueDate": "Définir une échéance (ajouter à l'agenda)",
        "item.form.dueDate": "Échéance",
        "item.form.dueDate.hint": "Cet exercice sera automatiquement synchronisé avec votre agenda.",
        ...
        "import.success": "Import réalisé avec succès !",
        "import.title": "Importer des opérations",
        "action.import": "Importer le fichier",
        "import.error.format": "Format de fichier non supporté.",
        ...
        "folder.edit": "Renommer le dossier",
        "folder.edit.title": "Renommer le dossier",
        "folder.rename.prompt": "Entrez le nouveau nom du dossier :",
        "folder.update.success": "Dossier renommé avec succès",
        "folder.update.error": "Erreur lors du renommage du dossier",
        ...
        "tts.pause": "Mettre en pause",
        "tts.resume": "Reprendre la lecture",
        "tts.stop": "Arrêter la lecture",
        "tts.speed": "Vitesse de lecture",
        "tts.empty": "Aucun texte à lire",
        "tts.unsupported": "Synthèse vocale non prise en charge par ce navigateur",
        "tts.error": "Erreur de synthèse vocale",
        "tts.reading": "Lecture à voix haute...",
        // New Additions
        ...
        "bulk.delete_confirm": "Êtes-vous sûr de vouloir supprimer les éléments sélectionnés ?",
        "bulk.delete_success": "Éléments supprimés avec succès",
        "bulk.delete_error": "Erreur lors de la suppression des éléments",
        "bulk.delete_partial_error": "Certains éléments n'ont pas pu être supprimés",
        "common.back": "Retour",
        // Settings Page
        ...
        "settings.interface.explorer": "Afficher la section Explorer (Mind Maps)",
        ...
        "settings.api.integrations": "Intégrations Externes (Google Drive, Calendar)",
        "settings.api.finance.title": "IA pour l'Audit Finance",
        "settings.api.finance.provider": "Fournisseur d'IA",
        "settings.api.finance.model": "Modèle d'IA",
        // Generation Menu
        ...
        "changelog.v200.title": "Édition Temps Réel, PDF & IA 🚀",
        "changelog.v200.notes_autosave": "Sauvegarde en direct : Enregistrement automatique type Google Docs avec badge d'état.",
        "changelog.v200.notes_wysiwyg": "Rendu WYSIWYG : Préservation fidèle des sauts de ligne entre lecture et édition.",
        "changelog.v200.pdf_viewer": "Lecteur PDF Hybride : Rendu natif ultra-rapide par défaut avec mode interactif fluide.",
        "changelog.v200.focus_mode": "Mode Plein Écran Mobile : Affichage immersif adapté à l'écran sans quitter la page.",
        "changelog.v200.grid_uniformity": "Vignettes Homogènes : Cartes calibrées au format 16:9 avec alignement des hauteurs.",
        "changelog.v200.flashcards": "Flashcards en Français : Interface traduite et support du formatage Markdown.",
        "changelog.v200.google_drive": "Google Drive Sync : Import et resynchronisation en 1 clic des documents modifiés.",
        "changelog.v200.ai_models": "Gemini 3.8 & Clés API : Nouveaux modèles IA avec isolation stricte de vos clés.",
        "changelog.v200.pwa": "PWA & Thème Minecraft : Application installable et lisibilité soignée en mode clair.",
        "changelog.v200.sidebar": "Barre Latérale Épurée : Navigation recentrée sur vos cours et dossiers.",
        ...
        "finance.title": "FinanceTrack",
        "finance.subtitle": "Gérez vos finances comme un pro.",
        "finance.dashboard.title": "Portefeuille",
        "finance.dashboard.newOp": "Nouvelle opération",
        "finance.dashboard.internal": "Virements internes",
        "finance.dashboard.internal.show": "Afficher les virements internes",
        "finance.dashboard.internal.hide": "Masquer les virements internes",
        "finance.dashboard.deleteAccount": "Supprimer ce compte",
        "finance.dashboard.deleteAccount.confirm": "Supprimer ce compte et toutes ses transactions ?",
        "finance.dashboard.deleteAccount.success": "Compte supprimé avec succès.",
        "finance.dashboard.audit.title": "Audit Financier",
        "finance.dashboard.audit.generating": "Génération de l'audit...",
        "finance.dashboard.audit.error": "Erreur lors de la génération de l'audit.",
        "finance.stats.balance": "Solde Total",
        "finance.stats.balance.all": "Tous comptes confondus",
        "finance.stats.income.month": "Revenus (Mois)",
        "finance.stats.expenses.month": "Dépenses (Mois)",
        "finance.stats.currentMonth": "Ce mois-ci",
        "finance.chart.title": "Evolution du solde",
        "finance.chart.activity": "Activité",
        "finance.chart.scale": "Échelle",
        "finance.chart.noData": "Aucune donnée pour cette période",
        "finance.chart.income": "Revenus",
        "finance.chart.expenses": "Dépenses",
        "finance.history": "Historique",
        "finance.refresh": "Rafraîchir",
        "finance.audit": "Audit",
        "finance.categorize": "Catégoriser",
        "finance.categorize.tooltip": "Catégoriser automatiquement les transactions via IA",
        "finance.categorize.success": "{{count}} transactions catégorisées",
        "finance.categorize.error": "Erreur de catégorisation IA",
        "finance.banks.swift.placeholder": "ex: SOGEFRPP",
        "finance.banks.title": "Mes Banques",
        "finance.banks.popular": "Banques populaires",
        "finance.banks.search": "Rechercher une banque...",
        "finance.banks.swift": "Code SWIFT/BIC",
        "finance.banks.swift.error": "Format SWIFT invalide (8 ou 11 caractères)",
        "finance.banks.swift.valid": "Format valide",
        "finance.banks.none": "Aucune banque trouvée",
        "finance.banks.hint": "Cliquez sur une banque pour pré-remplir le formulaire",
        "finance.banks.add": "Ajouter une banque",
        "finance.banks.connected.none": "Aucune banque connectée",
        "finance.banks.welcome": "Bienvenue dans FinanceTrack ! 👋",
        "finance.banks.welcome.desc": "Commencez par ajouter votre première banque pour centraliser tous vos comptes et suivre vos finances en temps réel.",
        "finance.banks.step1.title": "Ajoutez une banque",
        "finance.banks.step1.desc": "Créez votre première fiche bancaire",
        "finance.banks.step2.title": "Importez vos relevés",
        "finance.banks.step2.desc": "Support OFX, CSV et Excel",
        "finance.banks.step3.title": "Pilotez votre budget",
        "finance.banks.step3.desc": "Catégorisation et statistiques auto",
        "finance.banks.count": "{{count}} comptes",
        "finance.banks.edit": "Éditer",
        "finance.banks.archive": "Archiver",
        "finance.banks.archive.confirm": "Voulez-vous archiver cette banque ? Vous pourrez la restaurer plus tard.",
        "finance.banks.delete": "Supprimer définitivement",
        "finance.banks.delete.confirm": "⚠️ ATTENTION : Supprimer définitivement cette banque et toutes ses données ? Cette action est irréversible. Préférez 'Archiver' pour conserver vos données.",
        "finance.banks.noAccounts": "Aucun compte",
        "finance.banks.addAccount": "Ajouter un compte",
        "finance.accounts.edit": "Modifier le compte",
        "finance.accounts.add": "Ajouter un compte",
        "finance.accounts.name": "Nom du compte",
        "finance.accounts.name.placeholder": "ex: Compte Courant",
        "finance.accounts.type": "Type de compte",
        "finance.accounts.type.checking": "Compte Courant",
        "finance.accounts.type.savings": "Épargne",
        "finance.accounts.type.credit": "Crédit",
        "finance.accounts.type.investment": "Investissement",
        "finance.accounts.balance.initial": "Solde Initial",
        "finance.accounts.currency": "Devise",
        "finance.accounts.number": "Numéro de compte (Optionnel)",
        "finance.accounts.number.placeholder": "ex: ****1234",
        "finance.accounts.delete.confirm": "Supprimer ce compte et toutes ses transactions ?",
        "finance.budgets.title": "Budgets Mensuels",
        "finance.budgets.new": "Nouveau Budget",
        "finance.budgets.none": "Aucun budget défini. Commencez à suivre vos dépenses !",
        "finance.budgets.overview": "Vue d'ensemble du mois",
        "finance.budgets.pacing": "Vous êtes à {{pmonth}}% du mois et avez consommé {{pbudget}}% de votre enveloppe globale.",
        "finance.budgets.total": "Total Budgété",
        "finance.budgets.edit": "Modifier le budget",
        "finance.budgets.create": "Créer un budget",
        "finance.budgets.category": "Catégorie",
        "finance.budgets.category.placeholder": "Choisir une catégorie...",
        "finance.budgets.limit": "Montant Limite (€)",
        "finance.budget.monthly": "Mensuel",
        "finance.budget.yearly": "Annuel",
        "finance.budget.edit": "Modifier",
        "finance.budget.none": "Aucun budget défini",
        "finance.budget.add": "Nouveau Budget",
        "finance.budget.title": "Mes Budgets",
        "common.backToDashboard": "Retour au tableau de bord",
        "finance.bank.balance.total": "Solde total",
        "finance.tx.empty": "Aucune transaction",
        "finance.banks.add.first": "Ajouter ma première banque",
        "finance.hero.import.btn": "Importer un fichier",
        "common.actions.cancel": "Annuler",
        "finance.account.balance": "Solde",
        "finance.account.noIban": "Pas d'IBAN",
        "finance.account.balance.current": "Solde actuel",
        "finance.budget.limit.exceeded": "Limite dépassée de",
        "finance.budget.remaining": "Restant :",
        "finance.budget.pacing.high": "Rythme élevé",
        "finance.budget.pacing.low": "Rythme faible",
        "finance.budget.pacing.onTrack": "Sur la bonne voie",
        "finance.import.title": "Importer des Transactions",
        "finance.import.upload": "Importer",
        "finance.import.description": "Importez vos relevés OFX, CSV ou Excel.",
        "finance.import.step.upload": "Upload",
        "finance.import.step.preview": "Aperçu",
        "finance.import.step.result": "Résultat",
        "finance.import.bank.target": "Banque cible",
        "finance.import.bank.select": "Sélectionnez une banque...",
        "finance.import.bank.none": "Aucune banque configurée.",
        "finance.import.bank.createFirst": "Créez-en une d'abord.",
        "finance.import.account.target": "Compte cible (Optionnel)",
        "finance.import.account.help": "Sélectionnez un compte pour forcer l'import dessus, sinon FinanceTrack essaiera de le détecter.",
        "finance.import.account.auto": "Détection automatique",
        "finance.import.accounts.detected": "Comptes détectés",
        "finance.import.dropzone.change": "Changer de fichier",
        "finance.import.dropzone.placeholder": "Glissez votre fichier ici",
        "finance.import.dropzone.accepted": "OFX, CSV ou Excel acceptés",
        "finance.import.action.analyzing": "Analyse en cours...",
        "finance.import.action.continue": "Continuer vers Aperçu",
        "finance.import.action.confirming": "Importation...",
        "finance.import.action.confirmCount": "Confirmer l'import ({{count}})",
        "finance.import.summary.total": "Total Transactions",
        "finance.import.summary.new": "Nouveaux Ajouts",
        "finance.import.summary.duplicates": "Doublons Ignorés",
        "finance.import.toast.detectingBank": "Banque détectée : {{name}}",
        "finance.import.toast.success": "Import réussi !",
        "finance.import.toast.error.noFile": "Veuillez sélectionner une banque et un fichier.",
        "finance.import.loading": "Chargement des banques...",
        "finance.import.error.noIban": "Pas d'IBAN",
        "finance.import.success.title": "Import Réussi !",
        "finance.import.success.description": "Vos transactions ont été correctement importées et catégorisées.",
        "finance.import.success.action.dashboard": "Retour au Dashboard",
        "finance.import.success.action.another": "Importer un autre fichier",
        "finance.import.history.title": "Historique des Imports",
        "finance.import.history.none": "Aucun historique d'import disponible.",
        "finance.import.history.date": "Date",
        "finance.import.history.file": "Fichier",
        "finance.import.history.status": "Statut",
        "finance.import.history.imported": "Importés",
        "finance.import.history.duplicates": "Doublons",
        "finance.import.history.errors": "Erreurs",
        "finance.tx.new": "Ajouter une opération",
        "finance.tx.manual": "Saisie manuelle",
        "finance.tx.description": "Description",
        "finance.tx.description.placeholder": "ex: Loyer, Courses...",
        "finance.tx.amount": "Montant",
        "finance.tx.date": "Date",
        "finance.tx.category": "Category",
        "finance.tx.category.none": "Non classé",
        "finance.tx.noneMonth": "Aucune transaction ce mois-ci",
        "finance.tx.recent": "Transactions Récentes",
        "finance.tx.viewAll": "Voir tout",
        "finance.tx.success": "Opération réussie",
        "finance.settings.title": "Paramètres Finance",
        "finance.settings.description": "Gérez vos banques, comptes et préférences.",
        "finance.tx.edit.currentClassification": "Classification actuelle",
        "finance.tx.edit.suggested": "Suggéré",
        "finance.tx.edit.manual": "Manuel",
        "finance.tx.edit.reclassifying": "Recalcul en cours...",
        "finance.tx.edit.title": "Éditer la transaction",
        "finance.tx.edit.reclassify": "Re-classifier automatiquement",
        "finance.tx.classification.new": "Nouvelle classification",
        "finance.tx.classification.external": "Paiement Externe",
        "finance.tx.classification.external.desc": "Transaction vers un tiers (paiements, prélèvements, virements externes)",
        "finance.tx.classification.internal_intra": "Virement Interne (Même Banque)",
        "finance.tx.classification.internal_intra.desc": "Transfert entre comptes de la même banque",
        "finance.tx.classification.internal_inter": "Virement Interne (Banques Différentes)",
        "finance.tx.classification.internal_inter.desc": "Transfert entre vos comptes dans des banques différentes",
        "finance.tx.classification.unknown": "Inconnu",
        "finance.tx.autoReclassify": "Re-classifier tout",
        "finance.tx.autoReclassify.desc": "Relancer la classification pour toutes les transactions de cette catégorie.",
        "finance.tx.autoReclassify.success": "{{count}} transactions re-classifiées",
        "finance.filter.all": "Tous les types",
        "finance.filter.category": "Catégorie",
        "finance.filter.category.all": "Toutes les catégories",
        "finance.filter.account": "Compte",
        "finance.filter.account.all": "Tous les comptes",
        "finance.filter.active": "Filtre actif",
        "finance.filter.internal.hide": "Masquer virements internes",
        "finance.filter.internal.desc": "Afficher uniquement les flux externes",
        "finance.badge.suggested": "Suggéré",
        "finance.badge.manual": "Manuel",
        "finance.badge.confidence.high": "Confiance haute",
        "finance.badge.confidence.medium": "Confiance moyenne",
        "finance.badge.confidence.low": "Incertain",
        "common.confirmDelete": "Voulez-vous vraiment supprimer cet élément ?",
        "finance.tx.type": "Type",
        "finance.tx.type.expense": "Dépense",
        "finance.tx.type.income": "Revenu",
        "finance.tx.edit.success": "Opération mise à jour",
        "finance.tx.linkedAccount": "Compte bénéficiaire",
        "finance.tx.classification.unknown.desc": "Classification incertaine ou ambiguë",
        "finance.filter.advanced": "Filtres Avancés",
        "finance.filter.show": "Afficher",
        "finance.filter.hide": "Masquer",
        "finance.filter.amount": "Montant (€)",
        "finance.filter.min": "Min",
        "finance.filter.max": "Max",
        "finance.budget.pacing.ahead": "Vous êtes à {{pmonth}}% du mois et avez consommé {{pbudget}}% de votre enveloppe globale.",
        "finance.filter.reset": "Réinitialiser",
        "finance.filter.apply": "Appliquer",
        "finance.status.unknown": "Inconnu",
        "finance.status.payment": "Paiement",
        "finance.status.transfer": "Virement Interne",
        "common.uploading": "Téléchargement en cours...",
        "common.update": "Mettre à jour",
        "common.noData": "Aucune donnée disponible",
        "common.invalidDate": "Date invalide",
        "common.loadMore": "Charger plus",
        "common.remaining": "restants",
        "common.new": "Nouveau",
        ...
        "action.selectAll": "Tout sélectionner",
        "action.createCourse": "Nouveau Cours",
        "action.createFirstCourse": "Créer un premier cours",
        "sort.label": "Trier par",
        "sort.dateAdded": "Date",
        "sort.alphabetical": "Nom",
        "sort.lastOpened": "Dernier accès",
        "grid.columns": "Colonnes",
        "view.grid": "Grille",
        "view.list": "Liste",
        "nav.dashboard": "Tableau de bord",
        "library.desc": "Gérez tous vos cours et ressources d'apprentissage",
        "empty.noCourses": "Aucun cours trouvé",
        "course.edit": "Modifier le cours",
        "course.title": "Titre du cours",
        "course.placeholder": "ex. Mathématiques, Histoire...",
        "course.desc": "Description",
        "course.descPlaceholder": "Description du cours (optionnel)",
        "course.icon": "Icône",
        "folder.create.success": "Dossier créé avec succès",
        ...
        "exercise.error.noFocus": "Veuillez sélectionner au moins un axe de travail.",
        "settings.api.missing": "Clé API non configurée dans les paramètres",
        "error.generic": "Une erreur est survenue",
        "error.ai_missing": "Le service IA n'est pas configuré",
        "finance.tx.category.select": "Choisir une catégorie...",
        "finance.budget.limit": "Montant Limite (€)",
        "finance.categories.title": "Catégories",
        "finance.categories.placeholder": "Nom de la catégorie",
        "finance.categories.keywords.placeholder": "Mots-clés (séparés par des virgules)",
        "finance.categories.edit.name": "Nom de la catégorie",
        "finance.categories.edit.keywords": "Mots-clés",
        "finance.categories.edit.keywords.help": "Utilisés pour le classement automatique des transactions",
        "finance.categories.keywords.count": "mots-clés",
        "finance.dashboard.noData": "Aucune donnée financière pour l'instant",
        "finance.netWorth": "Patrimoine net",
        "finance.chart.cashflow": "Flux de trésorerie",
        "finance.chart.netWorth": "Évolution du patrimoine",
        "finance.account.notFound": "Compte introuvable",
        "finance.account.delete.confirm": "Voulez-vous vraiment supprimer ce compte ?",
        "finance.account.income.total": "Total Revenus",
        "finance.account.expense.total": "Total Dépenses",
        "finance.account.transactions.history": "Historique des transactions",
        "finance.account.add": "Nouveau compte",
        "finance.bank.notFound": "Banque introuvable",
        "finance.bank.delete.confirm": "Voulez-vous vraiment supprimer cette banque et ses comptes associés ?",
        "finance.bank.account.delete.confirm": "Voulez-vous vraiment supprimer ce compte ?",
        "finance.bank.accounts.associated": "Comptes associés",
        "finance.bank.accounts.none": "Aucun compte associé à cette banque",
        "finance.bank.accounts.none.help": "Ajoutez un compte pour suivre vos soldes et transactions",
        "finance.bank.accounts.addFirst": "Ajouter un premier compte",
        "finance.bank.backToBank": "Retour à la banque",
        "import.error.generic": "Erreur lors de l'import",
        "finance.import.account.select": "Sélectionnez un compte...",
        "finance.tx.history.title": "Transactions",
        "finance.tx.update.success": "Transaction mise à jour avec succès",
        "finance.tx.update.error": "Erreur lors de la mise à jour de la transaction",
        "finance.identify.pending": "Identification en cours...",
        "finance.identify.tooltip": "Catégoriser automatiquement avec l'IA",
        "finance.identify": "Catégoriser",
        "finance.tx.desc": "Description",
        "finance.optimize": "Optimiser",
        "finance.suggestion": "Suggestion",
        "finance.betterOffer": "Meilleure offre trouvée",
        "finance.savings": "Économies potentielles",
    },
    mc: {
        "app.title": "EduCraft",
        ...
        "common.locale": "en-US",
        "common.name": "NBT Name",
        "common.color": "Dye Color",
        "common.icon": "Texture",
        "common.optional": "Bonus",
        "common.currency": "Emeralds",
        "common.loading": "Chunk loading...",
        "common.submit": "Confirm Trade",
        "common.delete": "Sacrifice",
        "common.edit": "Enchant",
        "common.cancel": "Sneak",
        "common.save": "Save to Chunk",
        "common.saving": "Saving Chunks...",
        "common.saved": "Chunk Saved",
        "common.add": "Spawn",
        "action.cancel": "Sneak",
        "action.save": "Save to Chunk",
        "action.saving": "Saving Chunks...",
        "action.saved": "Chunk Saved",
        "action.delete": "Sacrifice",
        "action.edit": "Enchant",
        "action.add": "Spawn",
        "action.confirm": "Confirm Trade",
        "action.close": "Close GUI",
        "action.submit": "Confirm Trade",
        "action.refresh": "Respawn",
        ...
        "filter.resources": "Loot",
        "filter.exercises": "Quests",
        "filter.notes": "Books",
        "filter.flashcards": "Mob Spawner",
        "filter.quiz": "Trials",
        "filter.mindmaps": "Realm Maps",
        "filter.summaries": "Scrolls",
        "view.thumbnails_on": "Hide Item Frames",
        "view.thumbnails_off": "Show Item Frames",
        ...
        "item.form.hasDueDate": "Set Quest Timer (add to Calendar)",
        "item.form.dueDate": "Quest Timer",
        "item.form.dueDate.hint": "This quest will automatically appear on your World Map schedule.",
        "item.dueDate": "Timer",
        "item.form.desc": "Lore",
        ...
        "settings.tabs.interface": "HUD Settings",
        "settings.interface.title": "HUD Configuration",
        "settings.interface.explorer": "Show Minimap (Explorer)",
        ...
        "settings.api.integrations": "External Links (Ender Chest, Maps)",
        "settings.api.finance.title": "Villager Audit AI",
        "settings.api.finance.provider": "Redstone Hub",
        "settings.api.finance.model": "Command Script",
        // Generation Menu
        ...
        "finance.title": "FinanceTrack",
        "finance.subtitle": "Manage your emeralds like a pro.",
        "finance.dashboard.title": "Ender Chest",
        "finance.dashboard.newOp": "New Trade",
        "finance.dashboard.internal": "Inventory Moving",
        "finance.dashboard.internal.show": "Show inventory moving",
        "finance.dashboard.internal.hide": "Hide inventory moving",
        "finance.dashboard.deleteAccount": "Burn this chest",
        "finance.dashboard.deleteAccount.confirm": "Burn this chest and all its loot?",
        "finance.dashboard.deleteAccount.success": "Chest burned successfully.",
        "finance.dashboard.audit.title": "Ledger",
        "finance.dashboard.audit.generating": "Writing ledger...",
        "finance.dashboard.audit.error": "Ghost in the ledger.",
        "finance.stats.balance": "Total Stack",
        "finance.stats.balance.all": "All chests",
        "finance.stats.income.month": "Loot (Moon)",
        "finance.stats.expenses.month": "Loss (Moon)",
        "finance.stats.currentMonth": "This moon",
        "finance.chart.title": "Fortune History",
        "finance.chart.scale": "Zoom",
        "finance.chart.noData": "No loot found in this chunk",
        "finance.chart.income": "Loot",
        "finance.chart.expenses": "Loss",
        "finance.banks.title": "My Villagers",
        "finance.banks.add": "Hire Villager",
        "finance.banks.none": "No villagers found",
        "finance.banks.welcome": "Welcome to EduCraft Finance ! 👋",
        "finance.banks.welcome.desc": "Hire your first villager to manage your chests and track your emeralds in real time.",
        "finance.banks.step1.title": "Hire a villager",
        "finance.banks.step1.desc": "Build your first trading post",
        "finance.banks.step2.title": "Sort your loot",
        "finance.banks.step2.desc": "Supports Paper, Maps, and Books",
        "finance.banks.step3.title": "Farm your emeralds",
        "finance.banks.step3.desc": "Auto sorting and stats",
        "finance.banks.count": "{{count}} frames",
        "finance.banks.count_one": "1 frame",
        "finance.banks.count_other": "{{count}} frames",
        "finance.banks.edit": "Dye Frame",
        "finance.banks.archive": "Put in Chest",
        "finance.banks.archive.confirm": "Put this villager in a chest? You can summon them later.",
        "finance.banks.delete": "Sacrifice to Void",
        "finance.banks.delete.confirm": "⚠️ DANGER: Sacrifice this villager and all their data to the Void? This is irreversible. Put in Chest instead.",
        "finance.banks.noAccounts": "No frames",
        "finance.banks.addAccount": "Add a frame",
        "finance.accounts.edit": "Modify frame",
        "finance.accounts.add": "Add a frame",
        "finance.accounts.name": "Frame Label",
        "finance.accounts.name.placeholder": "e.g. Diamond Chest",
        "finance.accounts.type": "Type",
        "finance.accounts.type.checking": "Main Chest",
        "finance.accounts.type.savings": "Vault",
        "finance.accounts.type.credit": "Debt",
        "finance.accounts.type.investment": "Farm",
        "finance.accounts.balance.initial": "Initial Stack",
        "finance.accounts.currency": "Resource",
        "finance.accounts.number": "Frame NBT (Optional)",
        "finance.accounts.number.placeholder": "e.g. {Tags:['gold']}",
        "finance.accounts.delete.confirm": "Destroy this frame and all its loot?",
        "finance.budgets.title": "Monthly Quests",
        "finance.budgets.new": "New Quest",
        "finance.budgets.none": "No quest defined. Start tracking your loot!",
        "finance.budgets.overview": "Moonly Overview",
        "finance.budgets.pacing": "You are at {{pmonth}}% of the moon cycle and have consumed {{pbudget}}% of your global stack.",
        "finance.budgets.total": "Total Stacked",
        "finance.budgets.edit": "Modify quest",
        "finance.budgets.create": "Start a quest",
        "finance.budgets.category": "Category",
        "finance.budgets.category.placeholder": "Choose a loot type...",
        "finance.budgets.limit": "Quest Goal (Emeralds)",
        "finance.import.title": "Sort Loot",
        "finance.bank.balance.total": "Total Stack",
        "finance.tx.empty": "No loot drop",
        "finance.banks.add.first": "Summon my first villager",
        "finance.hero.import.btn": "Sort loot",
        "common.actions.cancel": "Abort",
        "finance.import.subtitle": "Sort your OFX, CSV, or Excel scrolls.",
        "finance.import.history": "Loot History",
        "finance.import.upload": "Upload",
        "finance.import.preview": "Identify",
        "finance.import.result": "Sorted",
        "finance.import.bank.target": "Target Villager",
        "finance.import.bank.placeholder": "Select a villager...",
        "finance.import.bank.detected": "Villager spawned: {{name}}",
        "finance.import.account.target": "Target Frame (Optional)",
        "finance.import.account.desc": "Select a frame to force loot into, otherwise we'll try to find the right chest.",
        "finance.import.account.auto": "Auto sorting",
        "finance.import.dropzone.active": "Drop your loot here",
        "finance.import.dropzone.idle": "Drag your loot here",
        "finance.import.dropzone.desc": "Paper scrolls accepted",
        "finance.import.file.change": "Toss file",
        "finance.import.button.preview": "Identify Loot",
        "finance.import.button.confirm": "Confirm Sort",
        "finance.import.success": "Loot sorted!",
        "finance.import.history.date": "Moon",
        "finance.import.history.file": "Scroll",
        "finance.import.history.status": "Status",
        "finance.import.history.imported": "Looted",
        "finance.import.history.duplicates": "Glitches",
        "finance.import.history.errors": "Fumbles",
        "finance.import.history.none": "No loot history in this chunk.",
        "finance.tx.new": "New Trade",
        "finance.tx.manual": "Hand-written",
        "finance.tx.description": "Description",
        "finance.tx.description.placeholder": "e.g. Rent, Diamond Sword...",
        "finance.tx.amount": "Emeralds",
        "finance.tx.date": "Time",
        "finance.tx.category": "Item Type",
        "finance.tx.category.none": "Unknown Block",
        "finance.tx.type": "Transaction",
        "finance.tx.type.expense": "Loss",
        "finance.tx.type.income": "Loot",
        "finance.tx.success": "Trade complete!",
        "finance.tx.edit.success": "Trade modified",
        "finance.filter.advanced": "Redstone Filters",
        "finance.filter.active": "Powered",
        "finance.filter.show": "On",
        "finance.filter.hide": "Off",
        "finance.filter.amount": "Emeralds",
        "finance.filter.min": "Min",
        "finance.filter.max": "Max",
        "finance.filter.account": "Chest",
        "finance.filter.account.all": "All chests",
        "finance.filter.internal.hide": "Hide item movement",
        "finance.filter.internal.desc": "Show only external trades",
        "finance.filter.reset": "Clear",
        "finance.filter.apply": "Accept",
