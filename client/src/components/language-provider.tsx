...
const translations: Translations = {
    en: {
        ...
        "changelog.v200.title": "Real-time Notes, Unified PDF Viewer & Next-Gen AI 🚀",
        "changelog.v200.notes_autosave": "Dynamic Auto-Save: Real-time automatic note saving on keystrokes (800ms debounce) with live status badge and typing protection.",
        "changelog.v200.notes_wysiwyg": "Unified WYSIWYG Rendering: 100% pixel-perfect consistency between viewing and editing notes, preserving line breaks and empty paragraphs.",
        "changelog.v200.pdf_viewer": "Hybrid PDF Viewer: High-performance native viewer by default (inline iframe) plus smooth interactive Canvas mode without console noise or memory leaks.",
        "changelog.v200.focus_mode": "In-Page Mobile Focus Mode: Immersive full-screen viewer adapted to device viewport (100dvh) without opening a new tab.",
        "changelog.v200.grid_uniformity": "Uniform Card Dimensions: Locked 16:9 thumbnails across all files (portrait/landscape PDFs, notes, quizzes) with aligned card heights.",
        "changelog.v200.flashcards": "Flashcards & Study: Full French localization, markdown support (bold, formatted lists) and responsive mobile study cards.",
        "changelog.v200.google_drive": "Google Drive Integration: Direct file picker from Google Drive with 1-click re-synchronization for updated documents.",
        "changelog.v200.ai_models": "Next-Gen Gemini AI: Support for Gemini 3.8, Gemini 3.7 and 3.6 Flash with automated fallback and strict per-user API key isolation (BYOK).",
        "changelog.v200.pwa": "PWA & Minecraft Theme: Installable mobile PWA with circular safe-zone icon, plus authentic parchment light mode contrast for Minecraft theme.",
        "changelog.v200.sidebar": "Streamlined Navigation: Cleaned sidebar with immediate access from course creation to course hierarchy.",
    ...
    fr: {
        ...
        "changelog.v200.title": "Édition Temps Réel, Visualiseur PDF & IA Nouvelle Génération 🚀",
        "changelog.v200.notes_autosave": "Sauvegarde Dynamique (Google Docs) : Enregistrement automatique en temps réel à chaque frappe (debounce 800ms) avec badge d'état interactif et protection de frappe.",
        "changelog.v200.notes_wysiwyg": "Rendu WYSIWYG Unifié : Alignement parfait à 100% entre le mode lecture et écriture des notes, préservation des sauts de ligne et paragraphes vides.",
        "changelog.v200.pdf_viewer": "Visualiseur PDF Hybride : Mode natif haute performance par défaut (iframe intégrée) et mode interactif Canvas fluide, sans saturation console ni fuite mémoire.",
        "changelog.v200.focus_mode": "Mode Focus In-Page Smartphone : Plein écran immersif adapté aux dimensions exactes du mobile (100dvh) sans ouvrir de nouvel onglet.",
        "changelog.v200.grid_uniformity": "Homogénéisation des Cartes : Vignettes 16:9 verrouillées pour tous les fichiers (PDF portrait/paysage, notes, quiz) et alignement strict des hauteurs.",
        "changelog.v200.flashcards": "Flashcards & Révisions : Traduction intégrale en français, support du Markdown (gras, listes) et cartes adaptatives sur smartphone.",
        "changelog.v200.google_drive": "Intégration Google Drive : Import direct de fichiers depuis Drive et resynchronisation en 1 clic pour mettre à jour les documents modifiés.",
        "changelog.v200.ai_models": "IA Gemini Nouvelle Génération : Support de Gemini 3.8, Gemini 3.7 et 3.6 Flash avec cascade de secours et isolation stricte des clés API (BYOK).",
        "changelog.v200.pwa": "Support PWA & Thème Minecraft : Application installable sur smartphone (PWA) et contraste parchemin haute lisibilité en mode clair Minecraft.",
        "changelog.v200.sidebar": "Navigation Épurée : Barre latérale allégée avec accès direct de la création à l'arborescence des cours.",
