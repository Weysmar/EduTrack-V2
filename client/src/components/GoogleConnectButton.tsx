...
export function GoogleConnectButton() {
    ...
    return (
        <button
            ...
            disabled={isLoading}
            className="flex items-center gap-2 px-6 py-3 bg-white border shadow-sm hover:shadow hover:bg-gray-50 rounded-lg transition-all text-gray-700 font-medium"
        >
