...
import { CompactFocusTimer } from '@/components/CompactFocusTimer'
    ...
    return (
        <div className="flex h-screen w-full overflow-hidden bg-background relative">
            ...
            <div className="flex-1 flex flex-col min-w-0 overflow-hidden transition-all duration-300">
                ...
                <main className={cn("flex-1 flex flex-col min-h-0", (location.pathname.includes('/study/') || location.pathname.includes('/item/')) ? "p-0 overflow-hidden" : "overflow-auto p-0 md:p-4 lg:p-6")}>
                    <Outlet />
                </main>
            </div>
        </div>
